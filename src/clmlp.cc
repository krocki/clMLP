...
void nntest ( int device, cl_device_type dev_type, int enable_profiling ) {
	...
	nn.layers.push_back ( new Sigmoid ( &ocl, 400, 400, batch_size ) );
	nn.layers.push_back ( new Linear ( &ocl, 400, 400, batch_size ) );
	nn.layers.push_back ( new ReLU ( &ocl, 400, 400, batch_size ) );
	nn.layers.push_back ( new Linear ( &ocl, 400, 100, batch_size ) );
	nn.layers.push_back ( new ReLU ( &ocl, 400, 100, batch_size ) );
