...
* @Last Modified time: 2017-04-27 19:30:59
*/
		...
		void train ( datapoints &data, float alpha, size_t iterations, bool show_loss = false ) {
			...
			for ( size_t ii = 0; ii < iterations; ii++ ) {
				...
				if ( show_loss ) {
					...
					double loss = cross_entropy_host ( errors.ref_host_data, logprobs.ref_host_data, layers.back()->y.ref_host_data, targets.ref_host_data );
