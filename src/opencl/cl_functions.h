...
* @Last Modified time: 2017-04-27 19:23:18
*/
...
void cl_matrix_randn ( cl_matrix<float> &y, bool wait = false ) {
	...
	y.matrix_ctx->err = clEnqueueNDRangeKernel ( y.matrix_ctx->queue(), y.matrix_ctx->kernels_rand["normal"], 1, NULL, &numWorkItems, NULL, 0, NULL, &y.matrix_ctx->event );
